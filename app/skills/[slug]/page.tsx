    ...
    <>
      ...
      <section className="content-panel skill-header">
        ...
        <div className="skill-actions">
          <a href={getSkillSourcePath(skill.slug)} className="button-link secondary">Open raw source</a>
